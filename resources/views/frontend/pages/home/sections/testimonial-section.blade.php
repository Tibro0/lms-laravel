        ...
        <div class="col-xl-4 wow fadeInUp">
            <div class="wsus__single_testimonial">
                ...
                <div class="testimonial_logo">
                    <img src="{{ asset('frontend/assets/images/testimonial_logo.png') }}" alt="Testimonial"
                        class="img-fluid">
                </div>
                <div class="wsus__testimonial_footer">
                    <div class="img">
                        <img src="{{ asset('frontend/assets/images/testimonial_user_1.png') }}" alt="user"
                            class="img-fluid">
                    </div>
                    <h3>
                        Spruce Springclean
        ...
        <div class="col-xl-4 wow fadeInUp">
            <div class="wsus__single_testimonial">
                ...
                <p class="description">Duis ullamcorper arcu egestas nisl luctus, sit amet lobortis lorem gravida
                    ...
                    lectus.</p>
                <div class="testimonial_logo">
                    <img src="{{ asset('frontend/assets/images/testimonial_logo_2.png') }}" alt="Testimonial"
                        class="img-fluid">
                </div>
                <div class="wsus__testimonial_footer">
                    <div class="img">
                        <img src="{{ asset('frontend/assets/images/testimonial_user_2.png') }}" alt="user"
                            class="img-fluid">
                    </div>
                    <h3>
                        Ravi O'Leigh
        ...
        <div class="col-xl-4 wow fadeInUp">
            <div class="wsus__single_testimonial">
                ...
                <p class="description">Duis ullamcorper arcu egestas nisl luctus, sit amet lobortis lorem gravida
                    ...
                    lectus.</p>
                <div class="testimonial_logo">
                    <img src="{{ asset('frontend/assets/images/testimonial_logo_3.png') }}" alt="Testimonial"
                        class="img-fluid">
                </div>
                <div class="wsus__testimonial_footer">
                    <div class="img">
                        <img src="{{ asset('frontend/assets/images/testimonial_user_3.png') }}" alt="user"
                            class="img-fluid">
                    </div>
                    <h3>
                        Hanson Deck

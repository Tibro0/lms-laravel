        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-6 wow fadeInLeft">
                <div class="wsus__about_3_img">
                    ...
                    <img src="{{ asset('frontend/assets/images/about_3_img_1.png') }}" alt="About us"
                        class="about_3_large img-fluid w-100">

                    <div class="text">
                        <h4> <span>20K+</span> Enrolled Learners</h4>
                        <img src="{{ asset('frontend/assets/images/banner_2_photo_list.png') }}" alt="Photo"
                            class="img-fluid">
                    </div>
            ...
            <div class="col-lg-6 wow fadeInRight">
                <div class="wsus__about_3_text">
                    ...
                    <div class="about_video">
                        <img src="{{ asset('frontend/assets/images/about_3_img_2.jpg') }}" alt="Video"

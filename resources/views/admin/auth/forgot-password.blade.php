    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
            ...
            <div class="card card-md">
                <div class="card-body">
                    <span class="text-muted">Forgot your password? No problem. Just let us know your email address and
                        we will email you a password reset link that will allow you to choose a new one.</span>
                    <br>
                    <br>
